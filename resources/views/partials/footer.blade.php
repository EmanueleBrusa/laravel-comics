<footer>
    <div class="cont">
        <div class="row">
            ...
            <div>
                <p class="site-content">All Site Content TM and 2020 DC Entertainment, unless otherwise <span class="text-primary">noted here</span>. All rights reserved.</p>
                <p class=" site-content text-primary">Cookies setting</p>
            </div>
        </div>
    </div>
    <div class="bg-footer">
